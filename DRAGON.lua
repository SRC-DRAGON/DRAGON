...
send(msg.chat_id_, msg.id_, t..'ٴ✹∫━━━━━━𝓓𝓡𝓖━━━━━━✹∫○ٴ\n✹∫ 彡 .[𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄](t.me/S0DRG)➢ ')
end
...
if text == "كيف ملفات المتجر" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = '✹∫ لتفعيل الردود والالعاب \n✹∫ ارسل الاوامر الاتيـه في الكروب ↓\n✹∫  تفعيل games.lua\n✹∫  تفعيل  Reply.lua\n✹∫ لإظهار المتجر اكتب المتجر في الكروب \n\n≪━━━━━━━━━━━━━≫\n✹∫ علامة تعني { ✓ } ملف مفعل\n✹∫ علامة تعني { ✘ } ملف معطل\n✹∫ قناة سورس دراكون ↓'
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
