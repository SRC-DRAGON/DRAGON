...
[[os.execute('rm -rf BOYKA.lua')]] #ملاحظة
[[os.execute('wget https://raw.githubusercontent.com/BOYKATEAM/BOYKA/master/BOYKA.lua')]] #ملاحظة
...
if text == 'رتبتي' or text == 'شنو رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,' ✹∫ رتبتك في البوت » '..rtp)
end
if text == "اسمي" or text == "شسمني" then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
...
if text == ("ايدي") or text == ("ا") and msg.reply_to_message_id_ == 0 and not database:get(bot_id..'Bot:Id'..msg.chat_id_) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, t..'ٴ✹∫━━━━━━𝕯𝕽𝕲━━━━━━✹∫○ٴ\n✹∫ 彡 .[𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄](t.me/S0DRG)➢ ')
end
