...
sudo_users = {SUDO,119541395,1355955429}   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DRAGONTEAM/Files_DRAGON/master/getfile.json")
if res == 200 then
...
zh = https.request('https://rudi-dev.tk/Amir1/DRAGON.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫━━━━━━𝘽𝙆━━━━━━❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/DRAGON.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/DRAGON.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
